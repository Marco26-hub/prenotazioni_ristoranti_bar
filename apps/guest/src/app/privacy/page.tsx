...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-2xl space-y-4 px-4 py-6 text-sm leading-relaxed">
      ...
      <h2 className="pt-2 font-semibold">Titolare del trattamento</h2>
      <p>
      ...
      <h2 className="pt-2 font-semibold">Dati raccolti e finalità</h2>
      ...
      <h2 className="pt-2 font-semibold">Base giuridica</h2>
      <p>
      ...
      <h2 className="pt-2 font-semibold">Destinatari</h2>
      <p>
      ...
      <h2 className="pt-2 font-semibold">Conservazione</h2>
      <p>
      ...
      <h2 className="pt-2 font-semibold">Diritti dell&apos;interessato</h2>
      <p>
