 ...
 */
export const DPA_VERSION = "2026-09-1";
 ...
 * preavviso di 30 giorni promesso nell'accordo decorre dalla pubblicazione.
 */
export const SOTTO_RESPONSABILI: SottoResponsabile[] = [
  {
    nome: "Neon (banca dati PostgreSQL)",
    attivita: "Conservazione di tutti i dati del servizio",
    dove: "Unione Europea — Francoforte",
  },
  {
